...
I can attest that the temptation to cut corners when someone is watching over your shoulder is greatly reduced!  You both exert a healthy influence on each other to do everything properly.
...
It is far more likely that a solo developer will get distracted by checking emails, browsing, etc.  I noticed that when pairing, we have a laser like focus on our goal, with neither person taking the time to deviate.  This is why pairing for a long period of time is mentally draining on both developers.
